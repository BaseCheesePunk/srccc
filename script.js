...
const baseNetwork = {
  chainId: "8453", // Chain ID Base Network
  chainName: "Base Network",
  rpcUrls: ["https://mainnet.base.org"], // Ganti dengan RPC URL Base Network
  nativeCurrency: {
    name: "ETH",
    symbol: "ETH",
    decimals: 18,
...
const contractAddress = "0xC09CbdD6a6e9381Fb73581b0ee5A536f0fEBb13c"; // Ganti dengan alamat kontrak Anda
const contractABI = [
  {
    "inputs": [],
